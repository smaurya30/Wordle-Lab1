...
class Dictionary():
    ...
    def getWord(self):
        try: 
            ...
            # DB Entry
            self.dataB.insertError("Error:", sys.exc_info()[0], " in getWord method, Dictionary module, occurred.".__str__())
    ...
    def checkIfWordExistInDict(self, inputWord):
        try:
            ...
            # DB Entry
            self.dataB.insertError("Error:", sys.exc_info()[0], " in checkIfWordExistInDict method, Dictionary module, occurred.".__str__())
