    ...
    def checkWordle(self, setOfEnteredWords, word, wordleWordList, gamesPlayed, winCount, count, flag, Counter, badWordSet, greenLetters, yellowLetters):
        try:
            ...
            # increment the user attempt after updating the colors
                ...
                result, badWordSet, greenLetters, yellowLetters = wm.wordleFunc(badWordSet, greenLetters, yellowLetters)
                # wm.wordleFunc()
            ...
            return setOfEnteredWords, gamesPlayed, winCount, count, flag, Counter, badWordSet, greenLetters, yellowLetters
        except:
            print(sys.exc_info())
    ...
    def wordleUi(self, wordleWord, flag, winCount, Counter, gamesPlayed):
        try:
            ...
            while count < 7:
                ...
                setOfEnteredWords, gamesPlayed, winCount, count, flag, Counter, badWordSet, greenLetters, yellowLetters = self.checkWordle(setOfEnteredWords, word, wordleWordList, gamesPlayed, winCount, count, flag, Counter, badWordSet, greenLetters, yellowLetters)
                if flag == -1:
